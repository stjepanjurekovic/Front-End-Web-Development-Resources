...
- [Peer-to-Peer Web Applications](https://www.manning.com/books/peer-to-peer-web-applications) - A book about peer-to-peer web apps that protect privacy and give users control over their own data.[Paid](https://img.shields.io/badge/-Paid-blue)
